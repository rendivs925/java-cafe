...
export default function HamburgerMenuWithCartAndAuthButtons({ toggleMobileMenu }: HamburgerMenuWithCartAndAuthButtonsProps): ReactElement {
  ...
  return (
    <>
      <div className="flex cursor-pointer gap-6 items-center">
        ...
        <div onClick={toggleMobileMenu} className="flex z-[100] flex-col items-center justify-between h-6 w-9 lg:hidden">
